...
// en array med olika värden i vårat object som är products.
const products = [
    {
...
//  numberOfAnimals: Int: nummer utan decimaler.
//  price: Float: nummer som innehåller decimaler

// isForSale: Boolean: svaras med true elr false
// hello. [string], är en array of strings.
...
const resolvers = {
    Query: {
        // vi returnera våra object och värden
        products: () => products,
